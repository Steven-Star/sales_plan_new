 ...
 */
@Data
public class NewTekMsrpWKVO {

    private String productName;



    @Excel(name = "SellingPriceId", type = Excel.Type.EXPORT)
    private Long id;
    ...
    @Excel(name = "SellingPrice", type = Excel.Type.EXPORT)
    private BigDecimal sellingPrice;

    /**
     * 币种
     */
    @Excel(name = "Currency", type = Excel.Type.EXPORT)
    private String currencyType;

    @Excel(name = "PromotionType", type = Excel.Type.EXPORT)
